...
# and and FLAG (ecological scenario) for the three different discount rates
...
datadirs <- c('data/optimization_output_summer_2016','data/Sensitivity_Discount01', 'data/Sensitivity_Discount07')

plotfilename <- "harvest.pathways.discountes.pdf"
